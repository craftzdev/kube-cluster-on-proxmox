...
TARGET_BRANCH=$1
TEMPLATE_VMID=9050
CLOUDINIT_IMAGE_TARGET_VOLUME=ds1621plus-iscsi
TEMPLATE_BOOT_IMAGE_TARGET_VOLUME=ds1621plus-iscsi
...
VM_LIST=(
    ...
    "1001 craftz-k8s-cp-1 2    8192  172.16.3.11 172.16.17.11 192.168.0.101 pve01"
    "1002 craftz-k8s-cp-2 2    8192  172.16.3.12 172.16.17.12 192.168.0.102 pve02"
    "1003 craftz-k8s-cp-3 2    8192  172.16.3.13 172.16.17.13 192.168.0.103 pve03"
    "1101 craftz-k8s-wk-1 4    12288 172.16.3.21 172.16.17.21 192.168.0.101 pve01"
    "1102 craftz-k8s-wk-2 4    12288 172.16.3.22 172.16.17.22 192.168.0.102 pve02"
    "1103 craftz-k8s-wk-3 4    12288 172.16.3.23 172.16.17.23 192.168.0.103 pve03"
)
