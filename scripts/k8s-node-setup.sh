...
function usage() {
    ...
    echo "  craftz-k8s-cp-1    run setup script for craftz-k8s-cp-1"
    echo "  craftz-k8s-cp-2    run setup script for craftz-k8s-cp-2"
    echo "  craftz-k8s-cp-3    run setup script for craftz-k8s-cp-3"
    echo "  craftz-k8s-wk-*    run setup script for craftz-k8s-wk-*"
}

case $1 in
    craftz-k8s-cp-1|craftz-k8s-cp-2|craftz-k8s-cp-3|craftz-k8s-wk-*)
        ;;
    help)
        usage
        exit 255
...
case $1 in
    craftz-k8s-wk-*)
        exit 0
        ;;
    craftz-k8s-cp-1|craftz-k8s-cp-2|craftz-k8s-cp-3)
        ;;
    *)
        exit 1
        ;;
...
case $1 in
    craftz-k8s-cp-1)
        ;;
    craftz-k8s-cp-2|craftz-k8s-cp-3)
        exit 0
        ;;
    *)
        exit 1
...
helm install argocd argo/argo-cd \
    ...
    --create-namespace \
    --namespace argocd \
    --values https://raw.githubusercontent.com/craftzdev/kube-cluster-on-proxmox/"${TARGET_BRANCH}"/k8s-manifests/argocd-helm-chart-values.yaml
helm install argocd argo/argocd-apps \
    --version 0.0.1 \
    --values https://raw.githubusercontent.com/craftzdev/kube-cluster-on-proxmox/"${TARGET_BRANCH}"/k8s-manifests/argocd-apps-helm-chart-values.yaml
...
# clone repo
git clone -b "${TARGET_BRANCH}" https://github.com/craftzdev/kube-cluster-on-proxmox.git "$HOME"/kube-cluster-on-proxmox
